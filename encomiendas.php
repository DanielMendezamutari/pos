        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    ...
                    <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Encomiendas</h5>
                    </div>
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                <li class="breadcrumb-item">Traspasos</li>
                                <li class="breadcrumb-item active" aria-current="page">Por Tracking</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-danger">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Búsqueda de Envios (Encomiendas)</h4>
            </div>
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                <label class="control-label">Búsqueda de Paquete: <span class="symbol required"></span></label>
