            ...
            <div class="form-group">
                ...
                <div class="form-check form-check-inline">
                    <div class="custom-control custom-radio">
                        <input type="radio" class="custom-control-input" id="ticket" name="tipodocumento" value="TICKETCOTIZACION" <?php if (isset($reg[0]['tipodocumento'])) { ?> <?php if($reg[0]['tipodocumento'] == "TICKETCOTIZACION") { ?> value="TICKETCOTIZACION" checked="checked" <?php } } else { ?> checked="checked" <?php } ?>>
...
?>
    ...
    <input type="hidden" name="precioconiva[]" id="precioconiva_<?php echo $count; ?>" value="<?php echo $detalle[$i]['ivaproducto'] == '0.00' ? "0" : number_format($detalle[$i]["precioventa"], 2, '.', ''); ?>"><?php echo number_format($detalle[$i]['precioventa'], 2, '.', ''); ?></td>
        ...
        <div class="row">
            ...
            <div class="col-md-1"> 
                <div class="form-group has-feedback"> 
                 ...
                 <input type="text" class="form-control" name="cantidad" id="cantidad" onKeyUp="this.value=this.value.toUpperCase();" autocomplete="off" placeholder="Ingrese Cantidad">
                 <i class="fa fa-bolt form-control-feedback"></i> 
                </div> 
            </div>
        </div>
