            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                        <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Ventas por Familia</h5>
                    </div>
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                <li class="breadcrumb-item">Ventas</li>
                                <li class="breadcrumb-item active">Ventas x Familia</li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-danger">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Ventas por Familia</h4>
            </div>
            <form class="form form-material" method="post" action="#" name="ventasxfamilias" id="ventasxfamilias">
    ...
    <div class="text-right">
        <button type="button" onClick="BuscaVentasxFamilia()" class="btn btn-danger"><span class="fa fa-search"></span> Buscar</button>
    </div>
...
<div id="muestra_resultados"></div>
    ...
    function BuscaVentasxFamilia() {
        ...
        $.get("funciones?BuscaVentasxFamilia=si&codsucursal="+codsucursal+"&desde="+desde+"&hasta="+hasta, function(data) {
