...
$url_1 = (empty($con[0]['url1']) ? "" : $con[0]['url1']);
$url_2 = (empty($con[0]['url2']) ? "" : $con[0]['url2']);
...
<body>
    <div class="main-wrapper">
        ...
        <!-- Login box.scss -->
        <!-- ============================================================== -->
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(assets/images/login-register.jpg) no-repeat center; position: absolute; height: 100%; width: 100%; background-size: 100% 100%;">
          
          <div class="ocultar-div">
            <div class="mostrar-div">

            <?php if (file_exists("fotos/imagen1.png")){ ?>
            <a href="<?php echo $url_1; ?>" target="_blank" rel="noopener noreferrer"><div id="contenedor" style="background:url(fotos/imagen1.png) no-repeat; background-position: center; background-size: 100% 100%;"></div></a>
            <?php } else { ?>
          ...
          <div class="ocultar-div">
            <div class="mostrar-div">
              ...
              <?php if (file_exists("fotos/imagen2.png")){ ?>
              <a href="<?php echo $url_2; ?>" target="_blank" rel="noopener noreferrer"><div id="contenedor" style="background:url(fotos/imagen2.png) no-repeat; background-position: center; background-size: 100% 100%;"></div></a>
              <?php } else { ?>
              <div id="contenedor"></div>
              <?php } ?>
