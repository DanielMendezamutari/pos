...
<body onLoad="muestraReloj()" class="fix-header">
   ...
   <!-- ============================================================== -->
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-boxed-layout="full" data-boxed-layout="boxed" data-header-position="fixed" data-sidebar-position="fixed" class="mini-sidebar">             
        ...
        <h5 class="font-medium text-uppercase mb-0"><i class="fa fa-tasks"></i> Pedidos por Proveedor</h5>
                    </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-danger">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Pedidos por Proveedor</h4>
            </div>
            
        <form class="form form-material" method="post" action="#" name="pedidosxproveedor" id="pedidosxproveedor">
            ...
            <div class="form-group has-feedback">
                ...
                <?php } } ?>
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" onClick="BuscarPedidosxProveedor()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
...
<div id="muestrapedidosxproveedor"></div>
