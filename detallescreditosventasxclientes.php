        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group has-feedback">
                    ...
                    <input type="hidden" name="formulario" id="formulario" value="detallescreditosventasxclientes"/>
                    ...
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Detalles x Clientes</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-danger">
                <h4 class="card-title text-white"><i class="fa fa-tasks"></i> Detalles x Clientes</h4>
            </div>
            
        <form class="form form-material" method="post" action="#" name="detallescreditosventasxclientes" id="detallescreditosventasxclientes">
            ...
            <div class="form-group has-feedback">
                ...
                <i class="fa fa-search form-control-feedback"></i> 
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" onClick="BuscarDetallesCreditosVentasxClientes()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
