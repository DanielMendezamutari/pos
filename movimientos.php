        ...
        <div class="row">
            ...
            <div class="col-md-4">
               <div class="form-group has-feedback">
                    ...
                    <option value="<?php echo encrypt($medio[$i]['codmediopago']); ?>"<?php if(!(strcmp('EFECTIVO',$medio[$i]['mediopago']))) echo "selected"; ?>><?php echo $medio[$i]['mediopago']; ?></option> <?php } } ?>
                    </select>
                </div>
            </div>
    ...
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="movimientosxsucursal" id="movimientosxsucursal">
            ...
            <div class="text-right">
                <button type="button" id="BotonBusqueda" onClick="BuscaMovimientosxSucursal()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
            </div>
