    ...
    <div class="modal-dialog">
        ...
        <div class="row">
            ...
            <div class="modal-footer">
                ...
                document.getElementById('codsucursal').value = '<?php echo ($_SESSION['acceso'] == "administradorG" ? "" : encrypt($_SESSION['codsucursal'])); ?>',
    ...
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="arqueosxsucursal" id="arqueosxsucursal">
            ...
            <div class="text-right">
                <button type="button" id="BotonBusqueda" onClick="BuscaArqueosxSucursal()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
            </div>
