...
function AsignaPrecio(id, codigo, tipodetalle, producto, cantidad, precio2, descproducto)
{
  ...
  $("#agregaprecio #agrega_detalle_precio").load("detalles_productos?BuscaDetallesProductoxPrecio=si&variable=4&d_id="+id+"&d_codigo="+codigo+"&d_tipo="+tipodetalle+"&d_producto="+producto+"&d_cantidad="+cantidad+"&d_precio="+precio2+"&d_descproducto="+descproducto);
}
// ####################### FUNCION PARA ASIGNAR PRECIO VENTA A DETALLES #######################
...
$(document).ready(function() {
    ...
    $('#saveventas').keypress(function(e){
