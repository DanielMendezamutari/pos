    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-danger">
                <h4 class="modal-title text-white" id="myModalLabel"><i class="fa fa-align-justify"></i> Detalle de Cotización</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><img src="assets/images/close.png"/></button>
            </div>
            <div class="modal-body">

                <div id="muestracotizacionmodal"></div> 
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<!--############################## MODAL PARA PROCESAR COTIZACION A VENTA ######################################-->
    ...
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="cotizacionesxsucursal" id="cotizacionesxsucursal">
            ...
            <div class="text-right">
                <button type="button" id="BotonBusqueda" onClick="BuscaCotizacionesxSucursal()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-append">
                            <button type="button" id="BotonBusqueda" onClick="BuscarCotizaciones();" class="btn btn-success waves-effect waves-light" data-placement="left" title="Buscar Cotizaciones"><i class="fa fa-search-plus"></i></button>
                            </div>
