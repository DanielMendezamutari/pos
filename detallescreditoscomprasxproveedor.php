            ...
            <div class="form-group has-feedback">
                ...
                <?php } } ?>
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" onClick="BuscarDetallesCreditosComprasxProveedor()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
