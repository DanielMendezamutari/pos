    ...
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="clientesxsucursal" id="clientesxsucursal">
            ...
            <div class="text-right">
                <button type="button" id="BotonBusqueda" onClick="BuscaClientesxSucursal()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-left" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(164px, 35px, 0px);">
                                ...
                                <a class="dropdown-item" href="reportepdf?tipo=<?php echo encrypt("CLIENTESXCREDITOS") ?>" target="_blank" rel="noopener noreferrer" data-toggle="tooltip" data-placement="bottom" title="Exportar Pdf"><span class="fa fa-file-pdf-o text-dark"></span> Créditos Activos</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <button type="button" id="BotonBusqueda" onClick="BuscarClientes();" class="btn btn-success waves-effect waves-light" data-placement="left" title="Buscar Cliente"><i class="fa fa-search-plus"></i></button>
                            </div>
