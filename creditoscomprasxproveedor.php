        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group has-feedback">
                    ...
                    <input type="hidden" name="formulario" id="formulario" value="creditoscomprasxproveedor"/>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="creditoscomprasxproveedor" id="creditoscomprasxproveedor">
            ...
            <div class="form-group has-feedback">
                ...
                <?php } } ?>
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" onClick="BuscarCreditosComprasxProveedor()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
