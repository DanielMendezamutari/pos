            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group has-feedback">
                        ...
                        <?php
                        $dep = new Login();
                        $dep = $dep->ListarDepartamentosAsignados($reg[0]['id_provincia']);
                        if($dep==""){ 
                            echo "";
                        } else {
              ...
              <div class="col-md-3">
                  <div class="fileinput fileinput-new" data-provides="fileinput">
                    ...
                    <div>
                      ...
                      <a href="#" class="btn btn-dark fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times-circle"></i> Remover</a><small><p>Para Subir el Logo Pdf #1 debe tener en cuenta:<br> * La Imagen debe ser extension.png<br> * La imagen no debe ser mayor de 1 MB</p></small>                             </div>
                  </div>
              </div>
              ...
              <div class="col-md-3">
                  <div class="fileinput fileinput-new" data-provides="fileinput">
                    ...
                    <div>
                      ...
                      <a href="#" class="btn btn-dark fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times-circle"></i> Remover</a><small><p>Para Subir el Logo Pdf #2 debe tener en cuenta:<br> * La Imagen debe ser extension.png<br> * La imagen no debe ser mayor de 1 MB</p></small>                             </div>
                  </div>
              </div>
          </div>
