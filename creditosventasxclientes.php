        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group has-feedback">
                    ...
                    <input type="hidden" name="formulario" id="formulario" value="creditosventasxclientes"/>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="creditosventasxclientes" id="creditosventasxclientes">
            ...
            <div class="form-group has-feedback">
                ...
                <i class="fa fa-search form-control-feedback"></i> 
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" onClick="BuscarCreditosVentasxClientes()" class="btn btn-danger"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
