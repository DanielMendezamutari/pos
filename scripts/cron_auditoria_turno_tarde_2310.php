...
echo "========================================================\n";
echo "🌙 AUDITORÍA AUTOMÁTICA TURNO TARDE (1 MENSAJE POR SUCURSAL)\n";
...
foreach ($sucursales as $suc) {
    ...
    $textoMensaje = $service->generarMensajeAuditoriaSucursal($suc, 'Tarde', $fechaHoy, $fechaIso);
    ...
    $datosEnvio = [
        ...
        'caption' => "📄 {$nombre} - Auditoría y Control de Mermas Turno Tarde ({$fechaHoy})",
